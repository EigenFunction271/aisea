    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        <p className="text-lg md:text-xl text-white/80 mb-12 font-[family-name:var(--font-geist-mono)]">
          Explore all AI.SEA events, past and upcoming.
        </p>
        
        <div className="space-y-8 mb-12">
          <div className="border border-white/10 rounded-lg p-6 hover:border-white/20 transition-colors">
            <h2 className="text-2xl font-semibold mb-2">AI.SEA Week 2025</h2>
            <p className="text-white/70 mb-4">24 Nov 2025 - 30 Nov 2025</p>
          ...
          <div className="border border-white/10 rounded-lg p-6 hover:border-white/20 transition-colors">
            ...
            <p className="text-white/70 mb-4">View all our previous events and activities</p>
            <a
