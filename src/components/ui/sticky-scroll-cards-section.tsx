...
export function StickyFeatureSection({ 
  ...
  return (
    <div className={`${backgroundColor} font-sans`}>
      ...
      <div className="px-[5%]">
        <div className="max-w-7xl mx-auto">
          ...
          <section className="py-24 md:py-48 flex flex-col items-center">
            ...
            {showHeader && (headerTitle || headerDescription ? (
              <div className="text-center max-w-3xl mx-auto mb-16">
                {headerTitle && (
              ...
              {displayFeatures.map((feature, index) => (
                ...
                >
                  ...
                  <div className="flex flex-col justify-center">
                    <h3 className={`text-2xl md:text-3xl font-bold mb-4 ${feature.textColor.includes('white') ? 'text-white' : 'text-gray-900 dark:text-white'}`}>{feature.title}</h3>
